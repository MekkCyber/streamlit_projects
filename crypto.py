...
st.markdown("""
Top 100 cryptocurrency from the **CoinMarketCap**!
...
col1 = st.sidebar
# (2,1) means the col2 is twice as wide as the col3
col2, col3 = st.columns((2,1))
col1.header('Filters')

## Sidebar - Currency price unit
currency_price_unit = col1.selectbox('Select Quote currency', ('USD', 'BTC', 'ETH'))
...
def load_data():
    ...
    with open('file.json','w') as f :
        f.write(json.dumps(coin_data['props']['initialState']))
